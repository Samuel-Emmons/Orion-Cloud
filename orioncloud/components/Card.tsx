...
export const Card = ({file}: {file: CardFile}) => {
    ...
    return <article className="group relative flex h-full min-w-0 flex-col gap-4 rounded-2xl border border-gray-200 bg-white p-5 text-gray-900 shadow-sm transition hover:border-brand hover:shadow-md">
            <div className="flex items-center justify-between gap-3">
                <Thumbnail type={file.type} extension={file.extension} url={file.url} className="flex size-16 shrink-0 items-center justify-center overflow-hidden rounded-xl border border-gray-200 bg-gray-50" imageClassName="!size-12 rounded-lg"/>
            ...
            <div className="min-w-0 space-y-2 border-t border-gray-100 pt-4">
                <h2 className="truncate text-base font-semibold" title={file.name}>
